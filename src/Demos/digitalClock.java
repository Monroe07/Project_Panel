...
public class digitalClock extends JPanel implements Runnable {
    ...
    Color dotColor = new Color(225, 225, 225);

    public void showMode(Graphics2D g2) {

        System.out.println("afNoon: " + afNoon + "\tMode: " + mode);
        if (afNoon && mode == "pm") {
...
class digitalNumber {
    ...
    public digitalNumber(int x, int y, int k) {
        ...
        leds[4] = new led(x + 2 * k, y - 9 * k - 6, "horiz");
        leds[5] = new led(x + 2 * k, y + k, "horiz");
        leds[6] = new led(x + 2 * k, y + 11 * k + 6, "horiz");
    }
    ...
    class led {
        ...
        Color numberColor = new Color(225, 225, 225);

        public void render(Graphics2D g2) {
            g2.setColor(new Color(45, 45, 45));
            if (lightOn) g2.setColor(numberColor);
            g2.fillPolygon(p);
        }
