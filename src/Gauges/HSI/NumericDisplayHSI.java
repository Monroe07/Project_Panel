 ...
 * @since 2017-05-16
 */
public class NumericDisplayHSI {
	double value;
     ...
     * @param fontsize
     */
	NumericDisplayHSI(int fontsize) {
		cx = 0;
		cy = 0;
		
		dispFont = new Font("Helvertica", Font.BOLD, fontsize);
		
		numberColor = Color.black;		// ets Color for numbers shown in 7 segment displays of Gauges.HSI.HSI
     ...
     * @return
     */
	String valueToString(double _Head) {
		...
		//overflow values
		while (_Head > maxValue) _Head -= maxValue;
			
		//parse value to string
		String salt = Integer.toString((int) _Head);
