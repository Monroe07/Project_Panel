 ...
 * @since 2017-05-16
 */
public class ADI_Picture extends JFrame {
 ...
 */
	public ADI_Picture() throws IOException, URISyntaxException{
...

	{
         ...
         */
		public ADIPanel () throws IOException, URISyntaxException {
			// Call Constructor of superclass
		    super();
			// Greats an Instance of the Gauges.ADI.ArtHorizon Class
			artHorizon = new ArtHorizon_Picture(sizex, sizey);
